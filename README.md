...
браузера, никакой Chromium для этого не нужен. Авто-обновление такие cookies
**не трогает** — иначе профиль из Debian молча подменил бы станцию на чужую.
Когда устареют, повтори команду; статус виден в ⚙.
