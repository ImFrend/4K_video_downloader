...
Выгрузить их можно любым расширением экспорта cookies (формат **Netscape**, не
JSON) — в Kiwi Browser работают расширения Chrome. Команда проверит файл до
замены: формат, наличие строк, маркеры входа — и откажет с внятной причиной,
если что-то не так.
